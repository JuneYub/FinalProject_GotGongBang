...
public class CraftVO {
	private int craft_num_pk;
	private String partner_id_fk;
	...
	private String craft_certificat;
	...
	private int craft_latitude;
	private int craft_longitude;
	private int craft_status;
	private float craft_rating;
	public int getCraft_num_pk() {
		return craft_num_pk;
	}
	public void setCraft_num_pk(int craft_num_pk) {
	...
	public String getCraft_certificat() {
		return craft_certificat;
	}
	public void setCraft_certificat(String craft_certificat) {
		this.craft_certificat = craft_certificat;
	}
	...
	public int getCraft_latitude() {
		return craft_latitude;
	}
	public void setCraft_latitude(int craft_latitude) {
		this.craft_latitude = craft_latitude;
	}
	public int getCraft_longitude() {
		return craft_longitude;
	}
	public void setCraft_longitude(int craft_longitude) {
		this.craft_longitude = craft_longitude;
	}
	public int getCraft_status() {
		return craft_status;
	}
	public void setCraft_status(int craft_status) {
		this.craft_status = craft_status;
	}
	public float getCraft_rating() {
		return craft_rating;
	}
	public void setCraft_rating(float craft_rating) {
