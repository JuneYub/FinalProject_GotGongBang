...
//AES256은 기본생성자가 있어야 bean으로 올라갈 수 있다.
//(bean으로 올라가기 위해서는 기본생성자가 존재해야 하는데
...
public class AES256 {
    ...
    public AES256(String key) throws UnsupportedEncodingException {
    	//AES256(String key)는 parameter가 있는 생성자이기 때문에
    	//parameter가 있는 생성자가 있을 경우, 기본생성자가 사라져 버린다!
    	//==> 따라서 #43. 양방향 암호화 알고리즘인 AES256 암호화를 지원하는 클래스 생성하기 의 과정이 필요하다.
