                        ...
                        <li>
                          <c:forEach var="inquiryvo" items="${requestScope.iqvo}">
                                <div class="ojh_table2_notice1">
	                                ...
	                                <c:if test="${inquiryvo.depthno > 0}">
	                                    	<span class="subject t15_admin" name="inquiry_title" style="cursor:pointer;" onclick="goView('${inquiryvo.inquiry_num_pk}')"><span style="color: red; font-style: italic; padding-left: ${boardvo.depthno * 20}px;">└Re&nbsp; </span> ${inquiryvo.inquiry_title} </span>
                                    </c:if> 
                                    	...
                                    	<div class="ojh_table2_notice4 t16">
	                                    	...
	                                    	<c:if test="${inquiryvo.partner_chk == '0' && inquiryvo.user_id_fk != 'admin'}">
	                                    		<div><span class="ojh_table2_notice4_1" style="color: #b3b3b3">일반사용자</span></div>
	                                    	</c:if>
	                                    	
	                                    	<c:if test="${inquiryvo.partner_chk == '1'}">
	                                    		<div><span class="ojh_table2_notice4_1" style="color: #66a3ff">파트너사용자</span></div>
	                                    	</c:if>
