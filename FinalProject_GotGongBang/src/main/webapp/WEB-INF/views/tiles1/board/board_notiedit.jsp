  ...
  $(document).ready(function(){
	  ...
	  $("button#btnUpdate").click(function(){
		...
		<%--내용 유효성 검사(스마트 에디터 사용 할 경우) 시작  --%>
			let inquiry_content = $("textarea#notice_content").val();
		...
		frm.method = "post";
		frm.action = "<%= ctxPath%>/notieditEnd.got";
		frm.submit();
	  });
                    ...
                    <table class="ojh_table table--row">
                        <div class="ojh_qulist">
                            ...
                            <div class="ojh_css-1dhg94g e1pwb5hv0">
                                ...
                                <input type="hidden" name="notice_num_pk" id="notice_num_pk" class="ojh_css-8vgw34 e1pwb5hv1" value="${requestScope.novo.notice_num_pk}" readonly />
                                <div style="padding: 12px 0px 0px 26px;" name="admin_id_fk" id="admin_id_fk">${requestScope.novo.admin_id_fk}</div>
                            </div>									 
                            ...
                            <div class="ojh_css-1dhg94g e1pwb5hv0">
                                ...
                                <input type="text" name="notice_title" id="notice_title" size="60" value="${requestScope.novo.notice_title}" />
                            </div>
                            
                            
                        </div>
                        <div class="ojh_css-1xvp3jp ezf0ge90">
                             <textarea style="width: 100%; height: 612px; border: 1px solid rgb(244, 244, 244);" name="notice_content" id="notice_content">${requestScope.novo.notice_content}</textarea>
                        </div>
