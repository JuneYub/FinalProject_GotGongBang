...
<script type="text/javascript">
   ...
   $(document).ready(function(){
      ...
      $("button#btnSearch").click(function() {
         ...
         console.log("str_DeptId:"+str_DeptId);
        /*
         str_DeptId:10
         empList.action:208 str_DeptId:10
         empList.action:208 str_DeptId:10,20
         empList.action:208 str_DeptId:-9999,10,20
         empList.action:208 str_DeptId:-9999,10,20,30
        */ 
   ...
   // ======== 체크박스 유지시키기 시작 ======== //
      ...
      $("button#btn_upload_excel").click(function(){
    	  ...
    	  if($("input#upload_excel_file").val() == "") {
    		  ...
    		  // ==> 첫번째 ajaxForm 을 사용하는 것(view.jsp 참조)
    		  // ==> 두번째로 formData 를 사용하는 것 
         ...
         <c:if test="${not empty requestScope.empList}">
            <c:forEach var="map" items="${requestScope.empList}">
               <tr>
                  ...
                  <td style="text-align: right;"><fmt:formatNumber value="${map.monthsal}" pattern="#,###"/>${map.monthsal}</td>
