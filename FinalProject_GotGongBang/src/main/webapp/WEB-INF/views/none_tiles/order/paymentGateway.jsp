...
$(document).ready(function() {
   ...
   IMP.request_pay({
       ...
       buyer_name : '${requestScope.order_name}',	  // 구매자 이름 
       buyer_tel : '${requestScope.mobile}',    // 구매자 전화번호 (필수항목)
       buyer_addr : '${requestScope.mobile}',  
       buyer_addr_detail : '${requestScope.mobile}',
       buyer_postcode : '${requestScope.mobile}',
	   ...
	   */
		...
		*/
		//	opener.location.href = "javascript:goCoinUpdate('${requestScope.userid}','${requestScope.coinmoney}');";
			window.opener.goCoinUpdate('${requestScope.user_id_pk}','${requestScope.coinmoney}');
